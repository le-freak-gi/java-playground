...
<div id="tabs">
	<ul>
        ...
        <li><a href="<c:url value="/cache" />" title="cache">Cache</a></li>
    </ul>
    <div id="simple">
		<h2>Simple</h2>
		<p>
...
$(document).ready(function() {
	...
	$("a.textLink").click(function(){
		var link = $(this);
		$.ajax({ url: link.attr("href"), dataType: "text", success: function(text) { debugger; MvcUtil.showSuccessResponse(text, link); }, error: function(xhr) { MvcUtil.showErrorResponse(xhr.responseText, link); }});
		return false;
	});
